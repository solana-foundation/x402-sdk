...
export const USDG_TESTNET_ADDRESS = USDG_DEVNET_ADDRESS;
...
export const STABLECOIN_MINTS = {
  ...
  USDG: {
    [SOLANA_MAINNET_CAIP2]: USDG_MAINNET_ADDRESS,
    [SOLANA_DEVNET_CAIP2]: USDG_DEVNET_ADDRESS,
    [SOLANA_TESTNET_CAIP2]: USDG_TESTNET_ADDRESS,
  },
  PYUSD: {
...
export const STABLECOIN_TOKEN_PROGRAMS = {
